...
export const GrievanceCard: React.FC<GrievanceCardProps> = ({
  ...
  const displayDesc =
    lang === "hi"
      ? c.descriptionHindi || c.description
      : c.description || c.descriptionHindi;
  const displayLocation =
    lang === "hi"
      ? c.locationHindi || c.location
      : c.location || c.locationHindi;
  const displayWard =
    lang === "hi" ? c.wardHindi || c.ward : c.ward || c.wardHindi;
